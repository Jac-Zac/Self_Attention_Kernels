// v1_nofm.cpp - Same as v1.cpp but with fast-math optimizations disabled
// This file is used to benchmark the impact of -ffast-math compiler flags.

// Disable fast-math optimizations for this translation unit
// GCC: disable all fast-math related flags (-fno-fast-math)
#pragma GCC optimize("no-fast-math")

// Clang: control floating-point contraction (FMA fusion)
// "on" = standard conforming (only contract within expressions)
